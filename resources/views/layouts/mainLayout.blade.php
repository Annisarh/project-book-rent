...
<body>
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-neutral-primary-soft border-e border-default">
            <ul class="space-y-2 font-medium">
                @if (Auth::user()->role->name == 'admin')
                    ...
                    <li>
                        <a href="{{route('logout')}}" class="flex items-center px-2 py-1.5 text-body rounded-base hover:bg-neutral-tertiary hover:text-fg-brand group">
    ...
    <div class="pt-17 max-sm:pt-0 sm:ml-64">
