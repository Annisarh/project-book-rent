        ...
        <div class="min-w-md border rounded">
            <form action="" method="POST" class="p-8 space-y-4">
                ...
                <div class="flex flex-col justify-between items-center gap-2">
                    ...
                    <input type="text" id="phone" name="phone" class="border bg-gray-100 px-2 py-1 w-full" required autocomplete="off">
                </div>
                <div class="flex flex-col justify-between items-center gap-2">
                    <label for="address" class="w-full">Address</label>
                    <input type="text" id="address" name="address" class="border bg-gray-100 px-2 py-1 w-full" required autocomplete="off">
                </div>
                <button type="submit" class="bg-blue-800 text-white w-full px-8 py-2 mt-4">Register</button>
